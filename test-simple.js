...
async function runTests() {
  try {
    ...
    if (fs.existsSync(metricsPath)) {
      ...
      console.log(fs.readFileSync(metricsPath, 'utf-8').slice(0, 300) + '...');
    } else {
    ...
    if (fs.existsSync(diagramPath)) {
      ...
      console.log('File contents (first 300 chars):');
      console.log(fs.readFileSync(diagramPath, 'utf-8').slice(0, 300) + '...');
    } else {
    ...
    if (fs.existsSync(depsPath)) {
      ...
      console.log('File contents (first 300 chars):');
      console.log(fs.readFileSync(depsPath, 'utf-8').slice(0, 300) + '...');
    } else {
    ...
    if (fs.existsSync(memoryPath)) {
      ...
      console.log('File contents (first 300 chars):');
      console.log(fs.readFileSync(memoryPath, 'utf-8').slice(0, 300) + '...');
    } else {
